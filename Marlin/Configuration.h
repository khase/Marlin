...
#define STRING_CONFIG_H_AUTHOR "(Ken Hasenbank, Anet A8 config)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 291 }
